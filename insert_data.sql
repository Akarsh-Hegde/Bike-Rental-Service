...
from
    ...
    discount as D,
    bike_details as Bike
where
    B.coupon_code = D.coupon_code
    and B.bike_reg_no = Bike.registration_no
...
-- Display the Customer First name and Last Name who have returned the Bike on or before the Return Date
